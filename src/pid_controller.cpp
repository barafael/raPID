...
pid_result pid_controller::compute(const uint64_t now, const float measured,
    ...
    this->integral = this->integral > this->integral_limit ?
        this->integral_limit : this->integral;
    this->integral = this->integral < this->integral_limit * -1 ?
        this->integral_limit * -1 : this->integral;
    ...
    /* Output limit */
    result.sum = result.sum > this->output_limit ?
        this->output_limit : result.sum;
    result.sum = result.sum < this->output_limit * -1 ?
        this->output_limit * -1 : result.sum;
