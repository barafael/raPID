...
class FlightMode {
    ...
    public:
        FlightMode(pid_params_t roll_params_stbl, pid_params_t roll_params_rate,
                pid_params_t pitch_params_stbl,   pid_params_t pitch_params_rate,
                pid_params_t yaw_params_stbl,     pid_params_t yaw_params_rate,
